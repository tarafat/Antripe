...
final class ResponseMessage {
  ...
  static const String INTERNAL_SERVER_ERROR = "Something went wrong. Try again later"; // Failure, crash on the server side
  static const String NOT_FOUND = "URL not found. Try again later"; // Failure, resource not found
  static const String SIGN_UP_FAILED = "Sign Up ,Failed!"; // Failure, resource not found
  ...
  static const String ID_EXISTS_VERIFIED = "This ID already exists, Please login";
  static const String ID_EXISTS_NOT_VERIFIED = "This ID already exists, Please Verify";
...
final class ResponseCode {
  ...
  static const int ALREADY_EXISTS = 409; // failure, not found
  static const int EXISTS_NOT_VERIFIED = 406; // failure, not found
  static const int LOGIN_FAILURE = 208; // failure, not found
